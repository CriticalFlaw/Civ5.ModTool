...
namespace CivModTool.Models.XML.Buildings
{
    ...
    public class Row
    {
        ...
        [XmlElement(ElementName = "Water")] public int Water { get; set; }

        [XmlElement(ElementName = "River")] public int River { get; set; }

        [XmlElement(ElementName = "FreshWater")]
        public int FreshWater { get; set; }

        [XmlElement(ElementName = "Mountain")] public int Mountain { get; set; }

        [XmlElement(ElementName = "NearbyMountainRequired")]
        public int NearbyMountainRequired { get; set; }

        [XmlElement(ElementName = "Hill")] public int Hill { get; set; }

        [XmlElement(ElementName = "Flat")] public int Flat { get; set; }
        ...
        [XmlElement(ElementName = "Capital")] public int Capital { get; set; }
        ...
        [XmlElement(ElementName = "Cost")] public int Cost { get; set; }
        ...
        [XmlElement(ElementName = "HolyCity")] public int HolyCity { get; set; }
        ...
        [XmlElement(ElementName = "FoodKept")] public int FoodKept { get; set; }

        [XmlElement(ElementName = "Airlift")] public int Airlift { get; set; }
        ...
        [XmlElement(ElementName = "CityWall")] public int CityWall { get; set; }
