...
namespace CivModTool.Models.XML.Leader
{
    ...
    public class Row
    {
        ...
        [XmlElement(ElementName = "Boldness")] public int Boldness { get; set; }
        ...
        [XmlElement(ElementName = "Loyalty")] public int Loyalty { get; set; }
        ...
        [XmlElement(ElementName = "Meanness")] public int Meanness { get; set; }
